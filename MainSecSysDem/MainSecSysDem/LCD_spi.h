...
// Data/Command Pin = PB2
#define SET_DC_PIN                 PORTB |= 0b00000100
#define CLEAR_DC_PIN               PORTB &= ~0b00000100
// Chip Enable Pin = PB1
#define SET_SCE_PIN                PORTB |= 0b00000010
#define CLEAR_SCE_PIN              PORTB &= ~0b00000010
// Reset Pin = PB0
#define SET_RST_PIN                PORTB |= 0b00000001
#define CLEAR_RST_PIN              PORTB &= ~0b00000001
