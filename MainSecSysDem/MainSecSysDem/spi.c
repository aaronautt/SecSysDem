...
//modified by Aaron Crump (crumpa@mail.gvsu.edu)
...
/*--------------------------------------------------------------------------------------------------
  ...
  Description  :  Initialising atmega SPI for using with 5110 LCD
...

{
    ...
    SPCR = 0x51; //setup SPI, Spi enable (SPE), spi master (MSTR) and (SPR0) set high, 8Mhz/16 = 500Khz
